...
data_CG = open_array('S_total.CG.dict.TE_TIR.gff.100.npy')
data_CHG = open_array('S_total.CHG.dict.TE_TIR.gff.100.npy')
data_CHH = open_array('S_total.CHH.dict.TE_TIR.gff.100.npy')
#print(data_CG)
#plt.ylim(0,0.1)
