...
file_CG = 'S_total.CG.q.dict.exonmethylv.txt'
file_CHG = 'S_total.CHG.q.dict.exonmethylv.txt'
file_CHH = 'S_total.CHH.q.dict.exonmethylv.txt'
...
plt.savefig('sunhwa_exonmet_plot.png',dpi=300)
plt.show()
