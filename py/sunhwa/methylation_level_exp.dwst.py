...
get_plot('S_total.CG.q.dict.downstream.methylv.txt',ax1,10)
get_plot('S_total.CHG.q.dict.downstream.methylv.txt',ax2,10)
get_plot('S_total.CHH.q.dict.downstream.methylv.txt',ax3,10)
ax1.set_ylim(0,150)
ax2.set_ylim(0,150)
ax3.set_ylim(0,150)
plt.savefig('dwstmet_exp_boxplot.png',dpi=300)
plt.show()
