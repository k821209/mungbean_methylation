...
data_CG = open_array('S_total.CG.q.dict.Vradi_ver6.gff.sort.gff.genelimit1k.gff.percent.npy')
data_CHG = open_array('S_total.CHG.q.dict.Vradi_ver6.gff.sort.gff.genelimit1k.gff.percent.npy')
data_CHH = open_array('S_total.CHH.q.dict.Vradi_ver6.gff.sort.gff.genelimit1k.gff.percent.npy')
#print(data_CG)
#plt.ylim(0,0.1)
...
plt.legend()
plt.savefig('mungbean_methyl_sup_fig_3.png',dpi=300)
plt.show()
