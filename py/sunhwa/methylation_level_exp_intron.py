...
get_plot('S_total.CG.q.dict.intronmethylv.txt',ax1,10)
get_plot('S_total.CHG.q.dict.intronmethylv.txt',ax2,10)
get_plot('S_total.CHH.q.dict.intronmethylv.txt',ax3,10)
ax1.set_ylim(0,150)
ax2.set_ylim(0,150)
ax3.set_ylim(0,150)
#plt.show()
plt.savefig('intronmet_exp_boxplot.png',dpi=300)
