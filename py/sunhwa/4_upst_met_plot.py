...
file_CG = 'S_total.CG.q.dict.upstream.methylv.txt'
file_CHG = 'S_total.CHG.q.dict.upstream.methylv.txt'
file_CHH = 'S_total.CHH.q.dict.upstream.methylv.txt'
...
plt.savefig('sunhwa_upst_met.png',dpi=300)
plt.show()
