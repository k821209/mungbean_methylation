...
file_CG = 'S_total.CG.q.dict.genemethylv.txt'
file_CHG = 'S_total.CHG.q.dict.genemethylv.txt'
file_CHH = 'S_total.CHH.q.dict.genemethylv.txt'
...
plt.savefig('sunhwa_genemet_plot.png',dpi=300)
plt.show()
