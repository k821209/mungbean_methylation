...
genebody_boolean = np.sum(genebody,axis=1)
genebody = genebody[(genebody_boolean>0)]
write_array2file(genebody,sys.argv[1]+'.'+sys.argv[2]+'.percent.npy')
'''
