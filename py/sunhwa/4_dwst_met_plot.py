...
file_CG = 'S_total.CG.q.dict.downstream.methylv.txt'
file_CHG = 'S_total.CHG.q.dict.downstream.methylv.txt'
file_CHH = 'S_total.CHH.q.dict.downstream.methylv.txt'
...
plt.savefig('sunhwa_dwst_met.png',dpi=300)
plt.show()
