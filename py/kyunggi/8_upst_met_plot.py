...
file_CG = 'K_all.CG.q.dict.upstream.methylv.txt'
file_CHG = 'K_all.CHG.q.dict.upstream.methylv.txt'
file_CHH = 'K_all.CHH.q.dict.upstream.methylv.txt'
...
plt.savefig('kyunggi_met_exp.upst.dotplot.png',dpi=300)
plt.show()
