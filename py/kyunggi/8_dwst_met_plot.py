...
file_CG = 'K_all.CG.q.dict.downstream.methylv.txt'
file_CHG = 'K_all.CHG.q.dict.downstream.methylv.txt'
file_CHH = 'K_all.CHH.q.dict.downstream.methylv.txt'
...
plt.savefig('kyunggi_met_exp.downstream.dotplot.png',dpi=300)
plt.show()
